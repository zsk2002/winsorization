...
path = Path("/Users/zhushangkai/Desktop/seasonal_liquidity/AER_all_articles/2b51d731-4b8e-44eb-b7ba-3ca54f2e406c.jsonl.gz")
...
old_path = "/Users/zhushangkai/Desktop/seasonal_liquidity/AER_all_articles.txt"
...
key_words = ["winsorization", "winsorized", "winsorizing", "winsor", "trimmed", "trimming",]  # example, replace with your own

merged["using_winsorization"] = merged["full_text"].apply(
    lambda txt: find_key_words(key_words, txt)
)
# merged.to_excel("/Users/zhushangkai/Desktop/seasonal_liquidity/All_AER_articles.xlsx")

cols_to_keep = ["item_id", "using_winsorization", "published_date", "ithaka_doi"]
...
winsorized.to_excel(
    "/Users/zhushangkai/Desktop/seasonal_liquidity/All_AER_articles_winsorized.xlsx",
    index=False,
)
