...
In the code folder:
    ...
    - analysis folder contains the code for checking if the paper uses winsorization and checking if the paper is empirical
        - Final way of checking for winsorization:
    ...
    - In the download paper folder, it contains the ways to download data from aer website and Jstor
    ...
    - In the theory folder, it contains the simulation:
        - clt_failed.py:
            - example of the failure of Central limit theorem based t test when it has heavy tail distribution
            - use student t distribution and pareto distribution
